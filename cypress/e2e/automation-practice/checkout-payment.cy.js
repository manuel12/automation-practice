...
describe("Checkout - Shipping", () => {
  ...
  context(
    "As a user I want to be able to confirm my payment by bank wire that I can complete the order:",
    () => {
      beforeEach(() => {
        cy.visit("http://www.automationpractice.pl/")
      ...
      it("should allow the user to confirm order by bank wire payment", () => {
        cy.get(".box")
          .should("be.visible")
          .and("include.text", "Bank-wire payment")
          .within(() => {
  ...
  context(
    "As a user I want to have confirmation my order payed by bank wire is complete so that I can know the order was successful:",
    () => {
      beforeEach(() => {
        cy.visit("http://www.automationpractice.pl/")
  ...
  context(
    "As a user I want to be able to confirm my payment by check so that I can complete the order:",
    () => {
      beforeEach(() => {
        cy.visit("http://www.automationpractice.pl/")
      ...
      it("should allow the user to confirm order by check wire payment", () => {
        cy.get(".box")
          .should("be.visible")
          .and("include.text", "Check payment")
          .within(() => {
  ...
  context(
    "As a user I want to have confirmation my order payed by check is complete so that I can know the order was successful:",
    () => {
      beforeEach(() => {
        cy.visit("http://www.automationpractice.pl/")
